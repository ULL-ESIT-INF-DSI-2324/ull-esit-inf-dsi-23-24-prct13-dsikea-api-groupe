...
furnitureRouter.get('/furnitures/id/:id', async (req, res) => {
    try {
...
furnitureRouter.get('/furnitures/price/:price', async (req, res) => {
    try {
...
furnitureRouter.get('/furnitures/stock/:stock', async (req, res) => {
    try {
...
furnitureRouter.get('/furnitures/serialNumber/:serialNumber', async (req, res) => {
    try {
